...
-(void) app_function
{
    ...
    /* Build pipeline */
    pipeline = gst_parse_launch("uridecodebin uri=http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ElephantsDream.mp4 !  videoconvert ! autovideosink", &error);
    if (error) {
