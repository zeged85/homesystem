...
- (void)refreshMediaItems {
    ...
    // Big Buck Bunny
    [entries addObject:@"http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ElephantsDream.mp4"];
    [entries addObject:@"http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/BigBuckBunny.mp4"];
