...
-(void) app_function
{
    ...
    //pipeline = gst_parse_launch("uridecodebin uri=http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ElephantsDream.mp4 ! tsdemux name=u  u. ! queue  ! autovideosink  u. ! queue ! audioconvert ! audioresample ! autoaudiosink", &error);
    
    //working jpeg
    //pipeline = gst_parse_launch("udpsrc  port=5000 ! application/x-rtp,encoding-name=JPEG,payload=26 ! rtpjpegdepay ! jpegdec ! autovideosink", &error);
