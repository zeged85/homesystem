...
int main(int argc, char *argv[]) {
  ...
  //data.video_sink = gst_element_factory_make("xvimagesink","video_sink"); //warped video problem
...
static void pad_added_handler (GstElement *src, GstPad *new_pad, CustomData *data) {
  ...
  // Check type of newly added
  if (g_str_has_prefix (new_pad_type, "audio/x-raw")) {
    g_print ("discoverd audio pad.\n");
    sink_pad = gst_element_get_static_pad (data->audio_convert, "sink");
  }
  else if (g_str_has_prefix (new_pad_type, "video/x-raw")) {
    g_print ("discoverd video pad.\n");
